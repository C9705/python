...
def reardata():
    ...
    import os
    global CTO
    data = xlrd.open_workbook(r"osAuto.xlsm").sheet_by_name('Sheet1')
    CTO=data.cell(0,0).value
    print(CTO)

def workUpLoad(Address,CTOnum,basicName):
    # login
...
if __name__ == "__main__":
    reardata()
    workUpLoad(r'http://lois.lenovo.com/lenovo-lois-web/main/main.html',CTO,'L1 CA')
